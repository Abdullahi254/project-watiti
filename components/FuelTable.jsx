...
function FuelTable({ numplate }) {
    ...
    const addFuelExpenseHandler = async (e) => {
        ...
        try {
            ...
            await setDoc(doc(db, `users/${currentUser.uid}/vehicles/${numplate}/fuel`, `${event.getTime()}`), {
        ...
        <div className='my-2 w-full border-2 rounded-lg overflow-x-auto relative bg-white py-6 px-4'>
...

            {
                showButton ? <div className='w-full my-2'>
                    ...
                    <form className="w-full max-w-[300px] mx-auto py-2" onSubmit={addFuelExpenseHandler}>
