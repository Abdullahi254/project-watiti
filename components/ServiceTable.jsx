...
function ServiceTable({ numplate }) {
    ...
    const addServiceExpenseHandler = async (e) => {
        ...
        try {
            ...
            await setDoc(doc(db, `users/${currentUser.uid}/vehicles/${numplate}/service`, `${event.getTime()}`), {
        ...
        <div className='my-2 w-full border-2 rounded-lg overflow-x-auto relative bg-white py-8 px-4'>
...

            {
                showButton ? <div className='w-full my-2'>
                    ...
                    <form className="w-full max-w-[300px] mx-auto py-2" onSubmit={addServiceExpenseHandler}>
