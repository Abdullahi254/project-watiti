    ...
    return (
        <div className='my-2 w-full border-2 rounded-lg overflow-x-auto relative bg-white py-8 md:px-4 text-xs md:text-sm'>
            <div ref={componentRef}>
                <h2 className='text-xs md:text-base mb-1 uppercase'>service expense ({numplate})</h2>
                ...
                <div className='w-full flex justify-start mt-2 px-6 py-4'>
                    {
                        latest ? <p className='italic text-xs md:text-sm underline'>Latest Expenses(5)</p> :
                            <p className='italic text-xs md:text-smunderline'>searched Results</p>
                    }
                    ...
                    <tbody>
                        ...
                        <tr className="bg-white border-b">
                            <th scope="row" className="py-4 px-6 font-bold text-xs md:text-sm text-gray-900 whitespace-nowrap uppercase">
                                TOTAL {!latest && <span className='italic text-xs md:text-smlowercase'>(searched)</span>}
                            </th>
                            <th scope="row" className="py-4 px-6 font-bold text-xs md:text-sm text-gray-900 whitespace-nowrap uppercase">
                ...
                showButton ? <div className='w-full py-2 flex justify-around'>
                    ...
                    <form className="w-full max-w-[400px] mx-auto flex-wrap" onSubmit={addServiceExpenseHandler}>
                        ...
                        <div className='flex border-b border-gray-500 py-2'>
                            ...
                            <button className=" self-center uppercase border-transparent disabled:bg-gray-300  flex-shrink-0 bg-gray-600 hover:bg-gray-900 border-gray-500  text-xs md:text-sm  text-white py-1 px-2 rounded" type="submit" disabled={disabled} >
                                Add
                            </button>
