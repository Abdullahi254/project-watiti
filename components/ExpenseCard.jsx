...
function ExpenseCard({ name, theme }) {
    return (
        <div className= {!theme ? ' my-2 xs:w-[70%] md:w-[48%]  bg-gradient-to-r from-gray-100 to-blue-300 py-6  px-4 text-black rounded-xl shadow-xl shadow-black relative':
        ' my-2 xs:w-[70%] md:w-[48%]  bg-gradient-to-r from-blue-100 to-red-300 py-6  px-4 text-black rounded-xl shadow-xl shadow-black relative' }>
